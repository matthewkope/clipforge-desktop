...
// Shared ClipForge icon art (a gradient disc with three "list/clip" lines),
// rendered at any size with a dependency-free PNG encoder. Used for both the
// browser-extension icons and the desktop app icon so they match exactly.
